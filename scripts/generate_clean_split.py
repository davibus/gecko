...
def build_clean_split_resume(output_path):
    doc = docx.Document()
    ...
    # Section Divider
    def add_section_header(title, space_before=4.5):
        p = doc.add_paragraph()
    ...
    # Job Header
    def add_job_header(title, company, location, space_before=3.0, page_break_before=False):
        ...
        if page_break_before:
            p_left.paragraph_format.page_break_before = True
    ...
    p_sum.paragraph_format.space_after = Pt(3.0)
...
def render_and_verify():
    ...
    pdf_p = r"c:\Users\DCALL\Desktop\gecko\scratch\preview_clean.pdf"
    
    build_clean_split_resume(docx_p)
    ...
    for i, page in enumerate(pdf):
        ...
        img_path = f"c:\\Users\\DCALL\\Desktop\\gecko\\scratch\\clean_page_{i+1}.png"
        pix.save(img_path)
