...
def build_split_resume_exact(output_path, font_size_pt=10.0, margin_in=0.42, bullet_space_p2=1.0, job_space_p2=2.2):
    doc = docx.Document()
    ...
    add_bullet("Scale & Portfolio Management: ", "Managed $30 million per month in advertising spend with a high-performing team of 4, optimizing cross-channel allocations to achieve aggressive acquisition and revenue targets.", space_after=1.8)
    add_bullet("Paid Search & Bid Architecture: ", "Engineered and optimized large-scale Google Ads and paid search campaigns; analyzed Max CPC vs. smart bidding, Brand vs. Non-Brand CPA thresholds, and keyword intent structures to eliminate ad waste.", space_after=1.8)
    add_bullet("Attribution & Predictive Analytics: ", "Executed Data-Driven Attribution (DDA) modeling, Customer Lifetime Value (LTV) evaluations, and 5-year predictive regression projections to forecast campaign returns and direct high-yield budget reallocations.", space_after=1.8)
    add_bullet("Full-Funnel Testing & Lead Systems: ", "Conducted comprehensive multi-tier funnel testing across reach, consideration, and conversion; audited Click-to-Call tracking systems and iSpot media attribution for offline/reach campaigns.", space_after=1.8)
    add_bullet("Marketing Automation & Dashboards: ", "Built automated reporting pipelines leveraging Python, SQL, Funnel.io, and Tableau/Looker Studio, consolidating live performance metrics across 10+ paid channels into unified dashboards.", space_after=1.8)
    add_bullet("AI-Assisted Operations: ", "Integrated modern AI tools including ChatGPT, Claude, and Codex to accelerate data aggregation, model query analysis, and dynamic ad messaging iterations.", space_after=1.8)
    ...
    add_bullet("Paid Media Growth & ROAS Scaling: ", "Directed all paid marketing channels (Google Ads, Bing Ads, Amazon, Facebook, Instagram, TikTok) with a $400k/month budget; scaled monthly revenue 4x from $200k/month to $800k/month while increasing ROAS from 1.5 to 3.5.", space_after=bullet_space_p2)
    add_bullet("Measurement & Tracking Infrastructure: ", "Architected executive and departmental KPI dashboards in Google Looker Studio; configured custom GA4 event tracking and Google Tag Manager (GTM) containers for granular cross-channel attribution.", space_after=bullet_space_p2)
    add_bullet("Lifecycle & Conversion Optimization: ", "Revamped email and SMS nurture flows to maximize customer retention and lifetime value; established rigorous landing page conversion rate optimization (CRO) and on-page SEO best practices.", space_after=bullet_space_p2)
    add_bullet("Cross-Department Planning: ", "Developed a robust multi-department inventory and demand-forecasting model aligning media spend directly with product availability and sales velocity.", space_after=bullet_space_p2)

    # Job 3: Intercon Inc.
    add_job_header("Director of E-Commerce & Marketing", "Intercon Inc.", "Salt Lake City, UT", space_before=job_space_p2)
    add_bullet("Digital Transformation & Lead Acquisition: ", "Led complete digital marketing and e-commerce transformation for a major B2B distributor, introducing high-volume B2C customer acquisition platforms while maintaining relationships with 650+ retail partners.", space_after=bullet_space_p2)
    add_bullet("CRM & Lifecycle Database Strategy: ", "Constructed customer database architectures and segmentation frameworks; deployed targeted re-engagement campaigns to reactivate dormant accounts and nurture high-value pipeline leads.", space_after=bullet_space_p2)
    add_bullet("Multi-Channel Campaign Leadership: ", "Directed multi-platform digital advertising, direct promotional outreach, and print/catalog collateral development utilizing Adobe Creative Suite (Photoshop, InDesign, Illustrator).", space_after=bullet_space_p2)
    ...
    add_bullet("Multi-Account Search Management: ", "Built, launched, and managed 75+ Google Ads accounts with total monthly spend surpassing $276,000, consistently achieving top-tier conversion rates and client ROI benchmarks.", space_after=bullet_space_p2)
    add_bullet("High-Intent Search & Account Sculpting: ", "Structured high-intent search campaigns with precise keyword match types, negative keyword scrubbing, ad copy A/B testing, and targeted landing page experiences.", space_after=bullet_space_p2)
    add_bullet("Automated Campaign Monitoring: ", "Programmed custom scripts in JavaScript/Python to automate real-time bid monitoring, budget pacing, and performance anomaly alerts, a system adopted agency-wide.", space_after=bullet_space_p2)
    add_bullet("Reporting & Multi-Channel Strategy: ", "Built unified client reporting in Funnel.io and Google Data Studio (Looker Studio), counseling clients across SEO, paid search, remarketing, and social media integration.", space_after=bullet_space_p2)
    ...
    add_bullet("Full-Funnel Paid Search & CRO: ", "Built and managed 150+ high-converting campaigns across Google Ads, Bing Ads, Gemini, and Amazon; conducted keyword research, custom attribution modeling, and multivariate landing page CRO.", space_after=bullet_space_p2)
    add_bullet("Lifecycle Marketing & Automation: ", "Built automated customer acquisition and email nurture funnels; developed custom JavaScript automations to optimize promotional campaigns based on real-time business targets.", space_after=bullet_space_p2)
    add_bullet("Executive Analytics & Reporting: ", "Monitored and reported core KPIs (CPA, ROAS, conversion paths) using Google Analytics, Magento, and QuickBooks to guide senior management forecasting.", space_after=bullet_space_p2)
...
def render_and_verify():
    ...
    pdf_p = r"c:\Users\DCALL\Desktop\gecko\scratch\preview_exact2.pdf"
    
    build_split_resume_exact(docx_p, font_size_pt=10.0, margin_in=0.42, bullet_space_p2=0.8, job_space_p2=2.0)
    ...
    for i, page in enumerate(pdf):
        ...
        img_path = f"c:\\Users\\DCALL\\Desktop\\gecko\\scratch\\exact2_page_{i+1}.png"
        pix.save(img_path)
