...
def build_resume_doc(margin_in=0.45, font_size_pt=10.2, line_spacing=1.15, 
                     space_after_bullet=1.2, space_before_section=3.5, space_before_job=2.5):
    doc = docx.Document()
    ...
    def add_section_header(title, space_before=space_before_section):
        p = doc.add_paragraph()
    ...
    def add_job_header(title, company, location, space_before=space_before_job):
    ...
    def add_bullet(lead_text, body_text, space_after=space_after_bullet):
    ...
    add_section_header("Core Competencies & Technical Skills", space_before=3.5)
    ...
    add_section_header("Professional Experience", space_before=3.5)
    ...
    # Job 2: GRIP6
    add_job_header("Director of Digital Marketing", "GRIP6", "Midvale, UT", space_before=2.8)
    ...
    # Job 3: Intercon Inc.
    add_job_header("Director of E-Commerce & Marketing", "Intercon Inc.", "Salt Lake City, UT", space_before=2.8)
    ...
    add_job_header("SEM Manager / Project Manager", "The Infinite Agency", "Dallas, TX", space_before=2.8)
    ...
    add_job_header("E-Commerce & Digital Marketing Manager", "LifeSpan Fitness", "Salt Lake City, UT", space_before=2.8)
...
def find_optimal_fit():
    ...
    test_configs = [
        ...
        (0.46, 10.2, 1.15, 1.3, 3.5, 2.6),
        (0.45, 10.1, 1.15, 1.2, 3.2, 2.5),
        (0.45, 10.0, 1.15, 1.2, 3.0, 2.2),
        (0.42, 10.2, 1.15, 1.4, 3.5, 2.6),
    ]
    ...
    if best_config:
        ...
        print("No exact 2-page fit in presets; will refine.")
