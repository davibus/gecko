...
def build_perfect_resume(output_path):
    doc = docx.Document()
    ...
    # Section Divider
    def add_section_header(title, space_before=3.5):
        p = doc.add_paragraph()
    ...
    # Bullet Points
    def add_bullet(lead_text, body_text, space_after=1.0):
    ...
    add_section_header("Professional Summary", space_before=2.5)
    p_sum = doc.add_paragraph()
    p_sum.paragraph_format.space_before = Pt(1)
    p_sum.paragraph_format.space_after = Pt(2.0)
    ...
    add_section_header("Core Competencies & Technical Skills", space_before=2.8)
    ...
    for cat, desc in comp_data:
        ...
        p_c.paragraph_format.space_after = Pt(1.2)
    ...
    add_section_header("Professional Experience", space_before=2.8)

    # Job 1: 1-800 Contacts
    add_job_header("Marketing Strategist / Senior Analyst", "1-800 Contacts", "Draper, UT", space_before=1.5)
    ...
    # Job 2: GRIP6
    add_job_header("Director of Digital Marketing", "GRIP6", "Midvale, UT", space_before=2.0)
    ...
    # PAGE 2 STARTS HERE
    # Job 3: Intercon Inc.
    add_job_header("Director of E-Commerce & Marketing", "Intercon Inc.", "Salt Lake City, UT", space_before=2.5)
    ...
    add_job_header("SEM Manager / Project Manager", "The Infinite Agency", "Dallas, TX", space_before=2.5)
    ...
    add_job_header("E-Commerce & Digital Marketing Manager", "LifeSpan Fitness", "Salt Lake City, UT", space_before=2.5)
    ...
    add_section_header("Education, Languages & Certifications", space_before=3.0)
...
def render_and_verify():
    ...
    pdf_p = r"c:\Users\DCALL\Desktop\gecko\scratch\preview_perfect.pdf"
    ...
    for i, page in enumerate(pdf):
        ...
        img_path = f"c:\\Users\\DCALL\\Desktop\\gecko\\scratch\\perfect_page_{i+1}.png"
        pix.save(img_path)
