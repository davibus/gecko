...
4. After items 1-3 are successfully created and `v2-qa.json` reports a native Word QA pass, add the job to `output/job-tracker.xlsx` with `scripts/manage_job_tracker.py add` and validate the tracker.
